-- 02_sacada_timeline.sql
-- Confirm the injected SACADA at 2026-03-15T14:00:00 (FIRE_GAS_HIGH, 6h)
...
-- 2026-03-15 along with the phase window. sacada_reason should be
...
GROUP BY sacada_phase, sacada_reason
